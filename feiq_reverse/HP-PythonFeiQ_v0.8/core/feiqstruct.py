...
# 文件内容
class FileContent(PacketContent):
    def __init__(self, file_id, filename, file_size, peer, tx):
        PacketContent.__init__(self, ContentType.FILE, peer, tx)
        self.file_id = file_id
        self.filename = filename
        self.file_size = file_size

    def __repr__(self):
        return 'FileContent(name=%s\tsize=%d)'%(self.filename, self.file_size)
